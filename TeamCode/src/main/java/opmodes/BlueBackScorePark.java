 ...
 */
@Autonomous(name = "Blue Back Score then Park", group = "Auto")
public class BlueBackScorePark extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                mecanumDrive.actionBuilder(beginPose)
                        .splineTo(new Vector2d(0, 0), 5*Math.PI / 4)  // Smooth curve
                        .build());

        Actions.runBlocking(
                mecanumDrive.actionBuilder(new Pose2d(0, 0, 5*Math.PI / 4))
